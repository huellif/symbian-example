...
//
// Implements a simple console application that uses functions supplied by OriginalDll
...
LOCAL_C void doExampleL()
	...
	//Attempt to use extension functionality
	
	//The following line will fail to link, as it requires the extension dll
