...
// This is v2 of the header, and includes some new functions added by the supplier to 
// demonstrate the def file being disrupted.
...
public: //functions
	...
	// New functions added by DLL supplier for version 2
