...
void show_buffer(TBufC<16> &bufc1)
    {
    // Look at: 
...
LOCAL_C void doExampleL()
    ...
    console->Printf(KCommonFormat6, &bufc2, bufc2.Ptr(), bufc2.Length(),
            bufc2.Size());

    console->Printf(KTxtTPtr);
    console->Printf(KCommonFormat7, &ptr, ptr.Ptr(), ptr.Length(), ptr.Size());
