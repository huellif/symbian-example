...
void CZoomControl::LoadBitmapL(CFbsBitmap* aBitMap, const TDesC& aPathAndFile,
...
void CZoomControl::DrawLeft(TRect screenRect, CWindowGc& SystemGc) const
	...
	SystemGc.DrawText(KTxtGrzoomExampleText, screenRect, exampleOffset,
...
void CZoomControl::DrawRight(TRect screenRect, CWindowGc& SystemGc) const
	...
	// draw text
	SystemGc.DrawText(KTxtGrzoomExampleText, screenRect, commentOffset,
			CGraphicsContext::ECenter, commentMargin);
	// discard and release font
	SystemGc.DiscardFont();
