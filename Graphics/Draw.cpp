...
void CDrawControl::Draw(const TRect& /* aRect */) const
	...
	switch (Phase())
		...
		case 16:
			...
			TSize cornerEllipseSize(cornerSize.iHeight * 2,
					cornerSize.iWidth * 2);
		...
		case 21:
			...
			gc.DrawText(KTxtDrawCase21, box, offset, CGraphicsContext::ELeft,
					margin);
			}
			break;
		...
		case 22:
			...
			gc.SetPenColor(white);
			gc.UseFont(iMessageFont);
			gc.DrawText(KTxtDrawCase22, box, offset, CGraphicsContext::ECenter,
					margin);
			}
			break;
		...
		case 23:
			...
			gc.UseFont(iMessageFont);
			gc.DrawText(KTxtDrawCase23, box, offset, CGraphicsContext::ERight,
					margin);
			}
			break;
